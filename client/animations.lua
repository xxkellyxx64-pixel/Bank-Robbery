function AnimateGrabCash(trolley)
    ...
    DeleteObject(bag)
    SetPedComponentVariation(player.Ped, 5, 0, 0, 0)
...
function AnimateHacking(panel)
    ...
    -- Replace the minigame with a simple wait to simulate hacking time
    Wait(3000) -- Wait 3 seconds instead of doing the minigame
    ...
    -- No return value needed since we're always setting success = true in the calling function
end
