BANK_TIMER = 10 * (1000 * 60)      -- 10 minutes (600000 milliseconds)
CLOSE_DOOR_TIMER = 10 * (1000 * 60) -- 10 minutes (600000 milliseconds)

POL_ALERT_TIME = 30 * 1000  -- 30 seconds (Time after robbery to alert police)
...
BANKS = {
    ...
    casino = {
        vault_hack = {
            ...
            position = vector3(912.61, 52.14, 72.04091796875),
            rotation = vector3(0.0, 0.0, 52.406)
        },
        vault_door = {
            model = GetHashKey("ch_prop_ch_vaultdoor01x"),
            position = vector3(915.18548583984, 55.969860076904, 72.44091796875),
            reset_yaw = -122.406,
            closestObject = true
        },
        first_cash = {
            model = GetHashKey("hei_prop_hei_cash_trolly_01"),
            position = vector3(904.41, 57.92, 71.89),
    ...
    pacificbank = {
        vault_hack = {
            model = GetHashKey("v_corp_bk_secpanel"),
            position = vector3(234.431, 221.172, 97.361),
            rotation = vector3(0.0, 0.0, 114.156)
        },
        vault_door = {
            model = GetHashKey("v_ilev_bk_vaultdoor"),
            position = vector3(236.471, 217.048, 97.761),
            reset_yaw = 115.754,
            closestObject = true
        },
        first_cash = {
            model = GetHashKey("hei_prop_hei_cash_trolly_01"),
            position = vector3(223.89, 221.21, 97.15),
            rotation = vector3(0.0, 0.0, 160.0)
        }
    },
    ...
    paletobank = {
        vault_hack = {
            model = GetHashKey("v_corp_bk_secpanel"),
            position = vector3(-101.99140075684, 6462.9640429688, 31.819064331055),
            rotation = vector3(0.0, 0.0, 225.71)
        },
        vault_door = {
            model = GetHashKey("ch_prop_ch_vault_d_door_01a"),
            position = vector3(-100.24186706543, 6464.5493164062, 31.884603500366),
            reset_yaw = -134.624,
            closestObject = true
        },
        first_cash = {
            model = GetHashKey("hei_prop_hei_cash_trolly_01"),
            position = vector3(-100.31, 6461.58, 31.63),
            rotation = vector3(0.0, 0.0, 160.0)
        }
    },
